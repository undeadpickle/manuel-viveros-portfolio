...
const INPUT_DIR = path.join(__dirname, '../public/images/sketches/original');
const OUTPUT_DIR = path.join(__dirname, '../public/images/sketches/optimized');
...
async function optimizeImage(inputPath) {
  try {
    ...
    // Always convert to JPG for better compression with sketches
...
async function processBatch() {
  ...
  console.log(`\nOutput: ${OUTPUT_DIR}`);
  console.log('\n✓ Done! Run upload-sketches-to-sanity.mjs next.');
}
